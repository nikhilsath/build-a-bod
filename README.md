...
- **CI:** GitHub Actions uses Xcode 16.2.0 to build the project and run all unit and UI tests on every PR. It prints available SDKs with `xcodebuild -showsdks`, lists simulators with `xcrun simctl list`, and targets an iPhone 14 on the latest iOS version.
